...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.mobileId = ID(9)
            this.mobileUrl = (process.env.VUE_APP_HTTPS === "true" ? 'https://' : 'http://') + process.env.VUE_APP_PUBLIC_HOST + (process.env.VUE_APP_PUBLIC_PORT ? ':'+ process.env.VUE_APP_PUBLIC_PORT : '') + '/#/camera/' + this.mobileId
